                    ...
                    <div class="card-body">
                        <div class="p-2 bg-light rounded rounded-pill shadow-sm mb-2">
                            <div class="input-group">
                                <input type="input" placeholder="Que recherchez-vous?" id="searchContratVoitureArchive"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="white-box">
                                                            ...
                                                            <page>
                                                                ...
                                                                <section>
                                                                    ...
                                                                    <div class="row"><span id="Contrat-Prix"></span>
                                                                        Euros HT par mois auquel se rajouterons le
                                                                        montant de la TVA (20%),
                                                                        Soit un prix TTC de :&nbsp <span
                                                                            id="Contrat-prix-TTC"></span> Euros
                                                                    </div>
                                                                    <div class="row">Kilométrage prévu &nbsp <span
                                                                            id="Contrat-KMPrevu"></span>&nbsp km/an
                                                                        (tarification du kilomètre supplémentaire 0.12
                                                                        €HT)</div>
                                                                </section>
                                                                <br>
                                                                <section>
                                                                    ...
                                                                    <div class="row content-text">
                                                                        <p>Le locataire verse à K2, une somme de &nbsp
                                                                            ...
                                                                            si celui-ci n’a pas été endommagé.
                                                                        </p>
                                                                    </div>
                                                                </section>
                                                                <section>
                                    ...
                                    <div class="table-responsive" id="contrat-list-archived"></div>
                                </div>
                            </div>
                        </div>
                    </div>
