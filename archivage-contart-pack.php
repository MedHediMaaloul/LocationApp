    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-heading">LISTE DES CONTRATS PACKS ARCHIVAGE</div>
                    <div class="card-body">

                        <!-- search box -->
                       <div class="p-2 bg-light rounded rounded-pill shadow-sm mb-2"> 
              <div class="input-group">
                <input type="input" placeholder="Que recherchez-vous?" id="searchContratPackArchive" class="form-control border-0  bg-light">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="white-box">
                                    ...
                                    <!-- end modal delet contrat -->
                                    <div class="table-responsive" id="contrat-list-pack-archivage"> </div>

                                    <!-- update Contrat modal -->
                                    <div class="modal fade" id="update-Contrat-Mixte" tabindex="-1" role="dialog"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="updateContratForm" autocomplete="off"
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <input type="hidden" id="up_idmixte">
                                                        </div>
                                                        <!-- <div class="form-group mb-4">
                              ...
                              <div class="col-md-12 border-bottom p-0">
                                <input id="up_Contratde" class="form-control p-0 border-0" style="color:black;font-size:20px" name="Entretiendate" disabled>
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="up_ContratTypeMixte"
                                                                    placeholder="type de contrat"
                                                                    class="form-control p-0 border-0" value="Mixte"
                                                                    disabled>
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <select name="duree" id="up_dureeContratMixte"
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">Date Contrat<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="date" id="up_DateContratMixte"
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-4">
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">Date Fin<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="date" id="up_DateFinContratMixte"
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">Prix<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="number" id="up_PrixContratMixte"
                                                                    placeholder="1000€"
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">Assurance<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="up_AssuranceContratMixte"
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">Caution<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="number" id="up_CautionMixte"
                                                                    placeholder="1000€"
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">N° de chèque de caution :<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="up_numCautionMixte"
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">Mode Paiement<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <select id="up_ModePaiementContratMixte"
                                                                    class="form-control p-0 border-0">
                                                        ...
                                                        <div id="up_inputDatePrelevementContrat" class="form-group mb-4"
                                                            ...
                                                            <label class="col-md-12 p-0">Date Prélèvement<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="date" id="up_DatePrelevementContratMixte"
                                                        ...
                                                        <div class="form-group mb-4" id="up_inputkmprevu"
                                                            ...
                                                            <label class="col-md-12 p-0">KM Prévu<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input id="up_VoitureKMPrevuMixte" type="number"
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-success"
                                                        id="btn_updated_Contrat_Mixte">Modifier Contrat</button>
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal"
                                                        id="btn-close">Fermer</button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal fade" id="Registration-Contrat-mixte" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-success"
                                                        id="btn-register-contrat-mixte">Ajouter Contrat</button>
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal"
                                                        id="btn-close">Fermer</button>
                                                </div>
                                            </div>
