                    ...
                    <div class="card-body">
                        ...
                        <div class="p-2 bg-light rounded rounded-pill shadow-sm mb-2">
                            <div class="input-group">
                                <input type="input" placeholder="Que recherchez-vous?" id="searchFactureContratVoiture"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="white-box">
                                    <div class="table-responsive" id="facture-list-contrat-voiture"></div>                      
                                </div>
                            </div>
                        </div>
                    </div>
