    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-heading"> Liste des utilisateurs</div>
                    <div class="card-body">
                        <p id="delete_message"></p>
                        <!-- #Registration-User   ExportUtilisateur5 -->
                        <button class="btn btn-success"  data-toggle="modal"
                            data-target="#Registration-User" style="font-size:25px;margin:5px;width: 50px;height:50px"
                        >+</button>
                        ...
                        <div class="p-2 bg-light rounded rounded-pill shadow-sm mb-2">
                            <div class="input-group">
                                <input type="input" placeholder="Que recherchez-vous?" id="searchUser"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="white-box">
                                    <div class="table-responsive" id="user-list"></div>
                                    <!-- show file modal -->
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Supprimer utilisateur
                                                    </h5>
                                    ...
                                    <div class="modal fade" id="updateUser" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p id="up_message"></p>
                                                    <form id="up-userForm" autocomplete="off"
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <input type="hidden" id="up_iduser">
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">Login<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="up_userLogin"
                                                                    placeholder="Utilisateur adresse"
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">Password<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="up_userPassword" placeholder=""
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">Etat <span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <select name="duree" id="updateuseretat"
                                                                    class="form-control p-0 border-0" required>
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-success" id="btn_update_user">Modifier
                                                        Utilisateur</button>
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal"
                                                        id="btn-close">Fermer</button>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="userForm" autocomplete="off"
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            $query = "SELECT * FROM agence where etat_agence!='S' ORDER BY id_agence ASC";
